...
import { Search, User, Printer, Send } from "lucide-react";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
import { studentDirectory, type Fee, type StudentProfile, type PaymentDetails } from "@/lib/mock-data";
...
Aedura Elite School
  ...
  const handleProcessPayment = () => {
    ...
    // Add to session storage for receipt list page
    const existingReceipts = JSON.parse(sessionStorage.getItem('feeReceipts') || '[]');
    sessionStorage.setItem('feeReceipts', JSON.stringify([newReceipt, ...existingReceipts]));
        ...
        <DialogContent className="max-w-2xl">
            ...
            {receiptDetails && (
              <div className="max-h-[60vh] overflow-y-auto my-4 border rounded-lg">
                <ReceiptTemplate details={receiptDetails} />
              </div>
            )}
